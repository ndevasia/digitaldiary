...
function HomePage() {
  ...
  const [oneMonthAgoScreenshotUrl, setOneMonthAgoScreenshotUrl] =
    useState(null);
  ...
  useEffect(() => {
    ...
    fetchScreenshotByDays(
      30,
      setOneMonthAgoScreenshotUrl,
      setLoadingOneMonthAgo
    );
  }, []);
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {loadingOneWeekAgo ? (
            ...
            <div className="bg-blue-100 w-full h-64 rounded flex items-center justify-center">
              <p className="text-gray-500 text-center">
                No screenshots from a week ago
              </p>
            </div>
          )}
        </div>
        ...
        >
          {loadingOneMonthAgo ? (
            ...
            <div className="bg-blue-100 w-full h-64 rounded flex items-center justify-center">
              <p className="text-gray-500 text-center">
                No screenshots from a month ago
              </p>
            </div>
          )}
        </div>
    ...
    return (
      <div>
        ...
        <h3 className="text-xl font-semibold text-gray-700 mb-4">
          {timeframeTitles[selectedTimeframe]}
        </h3>
          ...
          {currentScreenshotUrl ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-500">
                No screenshots available for this timeframe.
              </p>
            </div>
          )}
        </div>
