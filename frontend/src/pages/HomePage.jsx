...
function HomePage() {
    ...
    const [deleteConfirmation, setDeleteConfirmation] = useState({ visible: false, event: null, actionType: null, userDisplay: '' });
    ...
    const renderConfirmationModal = () => {
        ...
        const handleConfirm = async () => {
            setDeleteConfirmation({ visible: false, event: null, actionType: null, userDisplay: '' });
