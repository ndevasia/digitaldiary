...
(function() {
    ...
    window.showGameDetail = function(gameSlug) {
      ...
      sortedMedia.forEach(item => {
        ...
        // Inside the showGameDetail function where you generate mediaHTML
        if (item.type === 'screenshot') {
            mediaHTML += `
            <div class="media-item">
                <div class="media-thumbnail">
                <img src="${item.media_url}" alt="Screenshot" class="screenshot-img" onclick="enlargeImage('${item.media_url}')">
                </div>
    ...
    // Add this outside your IIFE to make it globally accessible
